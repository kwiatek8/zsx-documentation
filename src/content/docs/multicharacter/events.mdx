...
There are also specialized functions within the resource called "workers." Workers are event-driven functionalities designed to enhance the developer experience when working with our Multicharacter system. These provide additional capabilities for extending and customizing the resource. you can read about them in the files section under client/cl_worker.lua