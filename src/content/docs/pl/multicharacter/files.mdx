...
<Code code="RegisterNetEvent('ZSX_Multicharacter:Listener:WelcomeScreenStateChanged')
...
<Code code="WorkerBeforeInitiliazation = function()
...
<Tabs>
<TabItem label="config.lua">  <Code code="Config = {}
...
<TabItem label="shared_framework.lua"> <Code code="ESX = GetResourceState('es_extended') == 'started' and exports['es_extended']:getSharedObject() or false
